...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: My name is **Molly Buckler**. My major is *Data Science*. I am a sophmore at ISU.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: A job that is related to data science is working in bioinformatics. A lot of bioinformatics uses data science especially when it comes to genetic data which is a large part of bioinformatics. Genetic data sets can be massive and you need data science in order to make sence of the data and understand it.
    - https://www.ncbi.nlm.nih.gov/pmc/articles/PMC1122955/
    -![](https://www.houstonmethodist.org/-/media/Images/health-professionals/bioinformatics-comp-biology/Bioinformatics_Banner_1140x400.ashx?h=400&w=1140&hash=E09523440F7B9DEB52ACBCDA89A60DD0)
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: The data topic that I will be most interested in is health data. A place were you can find health datasets include both the CDC and dataworld.
...
7. Install git. 
    ...
    Answer: Done, there is $ before my prompt
...
<!-- Then explore the bash command line and Git. -->
    ...
    Answer: The git version is 2.28.0.windows.1
...
9. Configure your git username and user email by modifying and entering the following commands into the terminal
    ...
    Answer: Done, Molly Buckler, mbuckler@iastate.edu
